...
set_property  -dict {PACKAGE_PIN  K12  IOSTANDARD LVCMOS18} [get_ports ad9363_enable]
set_property  -dict {PACKAGE_PIN  K11  IOSTANDARD LVCMOS18} [get_ports ad9363_txnrx]

set_property  -dict {PACKAGE_PIN  M14  IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports adm1177_iic_scl_io]
set_property  -dict {PACKAGE_PIN  N14  IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports adm1177_iic_sda_io]

set_property  -dict {PACKAGE_PIN  E12  IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports ad9363_spi_csn]
set_property  -dict {PACKAGE_PIN  E11  IOSTANDARD LVCMOS18} [get_ports ad9363_spi_clk]
...
create_clock -name ad9363_spi_clk -period 40 [get_pins -hier */EMIOSPI0SCLKO]
